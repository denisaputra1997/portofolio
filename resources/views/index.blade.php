...
<head>
    ...
    <title>Deni's Portofolio - Index</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="/img/deni.png" rel="icon">
...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo"><img src="/img/deni.png" alt="" class="img-fluid"></a>
        ...
        <div class="container">
            <div class="hero-content">
                <h1>I'm <span class="typed"
                        data-typed-items="Deni Saputra, Designer, Developer, Freelancer"></span></h1>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-7">
                        <div class="about-descr">
                            ...
                            <p class="p-heading">
                                I am a graphic designer who provides logo creation services, 
                                illustrators, vectors, banners, web designs and other design products. </p>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="services-block">
                                ...
                                <p class="separator">To an English person, it will seem like simplified
                                    English,told me what </p>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 d-flex justify-content-center">
                        <ul id="portfolio-flters">
                            ...
                            <li data-filter=".filter-illustrator">Illustrator</li>
                            <li data-filter=".filter-vector">Vector</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row portfolio-container">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-logo">
                        <img src="/img/portfolio/logo1.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>Snacky Packy</h4>
                            <p>Logo</p>
                            <a href="/img/portfolio/logo1.jpg" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Snacky Packy"><i class="bx bx-plus"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-logo">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Logo</p>
                            <a href="/img/portfolio/logo2.jpg" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Kayla Jamur Crispy"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i
                                    class="bx bx-link"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="journal-info">
                                ...
                                <a href="blog-single.html"><img src="/img/blog-post-1.jpg" class="img-responsive"
                                        alt="img"></a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="journal-info">
                                ...
                                <a href="blog-single.html"><img src="/img/blog-post-2.jpg" class="img-responsive"
                                        alt="img"></a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="journal-info">
                                ...
                                <a href="blog-single.html"><img src="/img/blog-post-3.jpg" class="img-responsive"
                                        alt="img"></a>
                        ...
                        <div class="col-lg-6">
                            <div class="contact-contact">
                                ...
                                <ul class="contact-details">
                                    <li><span>Jl. Garuda VI Blok B11 No.21</span></li>
                                    <li><span>Jakamulya, South Bekasi, West Java</span></li>
                                    <li><span>+6289652489502</span></li>
                                    <li><span>deni97.saputra@gmail.com</span></li>
                                </ul>
